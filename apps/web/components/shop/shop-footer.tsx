        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>주말/공휴일 휴무</p>
              <p className="mt-2">
                <a href="mailto:support@photocafe.com" className="hover:text-white">
                  support@photocafe.com
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-sm text-center md:text-left">
              <p>(주)포토카페 | 대표: 홍길동 | 사업자등록번호: 123-45-67890</p>
          ...
          <div className="text-center text-sm mt-4 pt-4 border-t border-gray-800">
            <p>&copy; {new Date().getFullYear()} PhotoCafe. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
