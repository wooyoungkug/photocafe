 ...
 * 6MB: S3/B2 multipart 최소 청크 5MB 기준, 6MB부터 2청크 병렬 가능.
 * 2026-05-18 측정: 한국→B2(미국동부) 단일 PUT 200~400KB/s vs multipart 8MB/s — 20~30배 차이.
 * 단일 TCP 연결의 transcontinental throughput 한계가 주원인이라 임계값을 대폭 낮춤.
 */
