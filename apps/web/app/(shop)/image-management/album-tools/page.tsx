...
import { ImageRotateTool } from '@/components/image-management/tools/image-rotate-tool';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-sm mt-1">앨범 제작을 위한 이미지 분리, 늘리기, 합치기, 자르기, 회전 도구</p>
      </div>
      ...
      <Tabs defaultValue="split">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="rotate">이미지 회전</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="rotate"><ImageRotateTool /></TabsContent>
      </Tabs>
    </div>
  );
}
