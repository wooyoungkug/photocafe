...
function renderProcessBadge(currentProcess: string, deliveryMethod?: string) {
  ...
  return (
    <span className="inline-flex items-center whitespace-nowrap text-[13px] text-black font-normal">
      {label}
    </span>
  );
}
  ...
  return (
    <>
      ...
      {portalEl && createPortal(
        ...
        {/* 거래원장 테이블 */}
        <table className="w-full border-collapse text-[5pt]">
          <thead>
            ...
            {isLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[13px] text-black font-normal">
                  <thead>
                    <tr className="border-b bg-slate-50 text-[13px] text-black font-normal">
                  ...
                  <tbody>
                    {[...filteredDataWithBalance].reverse().map((row) => {
                      ...
                      return (
                        <Fragment key={row.date}>
                          <tr
                            className="border-b cursor-pointer hover:bg-slate-50 transition-colors text-[13px] text-black font-normal"
                          ...
                          >
                            ...
                            <td className="p-2 sm:p-3 text-[13px] text-black font-normal">
                            ...
                            <>
                              {isDetailFetching ? (
                                ...
                                filteredDetailData.data.map((order) => {
                                  ...
                                  return (
                                    <Fragment key={order.id}>
                                      <tr className="bg-slate-50/60 border-b hover:bg-slate-100/60 text-[13px] text-black font-normal">
                                        <td className="p-2 sm:p-3" />
                                        <td className="p-2 sm:p-3 whitespace-nowrap text-muted-foreground align-middle text-center">
                                          <div className="tabular-nums text-[13px] text-black font-normal">{order.orderNumber}</div>
                                          {order.createdAt && (
                                        ...
                                        <td className="p-2 sm:p-3 align-middle">
                                          <Link href={`/mypage/orders/${order.id}`} className="hover:underline cursor-pointer">
                                            ...
                                            {order.items?.[0]?.size && (
                                              <span className="text-[13px] text-black font-bold ml-1 whitespace-nowrap">
                                                {order.items[0].size}
                                              </span>
                                            )}
                                ...
                                <tr>
                                  <td colSpan={7} className="bg-slate-50/80 py-4 border-b text-center">
                                    <p className="text-[13px] text-black font-normal">거래 내역이 없습니다</p>
                                  </td>
                                </tr>
                              )}
                            </>
                    ...
                    {/* 당월합계 행 */}
                    <tr className="bg-gray-100 text-[13px] text-black border-t-2 font-semibold">
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3" />
