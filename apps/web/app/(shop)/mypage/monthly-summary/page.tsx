...
function renderProcessBadge(currentProcess: string, deliveryMethod?: string) {
  ...
  return (
    <span className="inline-flex items-center whitespace-nowrap text-[14px] text-black font-normal">
      {label}
    </span>
  );
}
            ...
            {isLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[14px] text-black font-normal">
                  <thead>
                    <tr className="border-b bg-slate-50 text-[14px] text-black font-normal">
                  ...
                  <tbody>
                    {[...dataWithBalance].reverse().map((row) => {
                      ...
                      return (
                        <Fragment key={row.date}>
                          <tr
                            className="border-b cursor-pointer hover:bg-slate-50 transition-colors text-[14px] text-black font-normal"
                          ...
                          >
                            ...
                            <td className="p-2 sm:p-3 text-[14px] text-black font-normal">
                            ...
                            <>
                              {isDetailFetching ? (
                                ...
                                detailData.data.map((order) => {
                                  ...
                                  return (
                                    <Fragment key={order.id}>
                                      <tr className="bg-slate-50/60 border-b hover:bg-slate-100/60 text-[14px] text-black font-normal">
                                        <td className="p-2 sm:p-3" />
                                        <td className="p-2 sm:p-3 whitespace-nowrap text-muted-foreground align-middle text-center">
                                          <div className="tabular-nums text-[14px] text-black font-normal">{order.orderNumber}</div>
                                          {order.createdAt && (
                                        ...
                                        <td className="p-2 sm:p-3 align-middle">
                                          <Link href={`/mypage/orders/${order.id}`} className="hover:underline cursor-pointer">
                                            ...
                                            {order.items?.[0]?.size && (
                                              <span className="text-[14px] text-black font-bold ml-1 whitespace-nowrap">
                                                {order.items[0].size}
                                              </span>
                                            )}
                                        ...
                                        <td className="p-2 sm:p-3 text-right tabular-nums align-middle text-[14px] text-black font-normal">
                                ...
                                <tr>
                                  <td colSpan={7} className="bg-slate-50/80 py-4 border-b text-center">
                                    <p className="text-[14px] text-black font-normal">거래 내역이 없습니다</p>
                                  </td>
                                </tr>
                              )}
                            </>
                    ...
                    <tr className="border-b bg-blue-50/50">
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3 whitespace-nowrap text-[14px] text-black font-normal">
                    ...
                    {/* 당월합계 행 */}
                    <tr className="bg-gray-100 text-[14px] text-black border-t-2 font-semibold">
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3" />
                    ...
                    {/* 기말잔액 행 */}
                    <tr className="bg-gray-50 text-[14px] text-black border-t font-bold">
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3 text-primary">
                        차월이월
                        {closingBalance > 0 && <span className="text-[14px] text-red-600">(미납금액)</span>}
                      </td>
                      <td className="p-2 sm:p-3" />
                      <td className="p-2 sm:p-3" />
                      <td
