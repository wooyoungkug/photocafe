            ...
            try {
                ...
                useAuthStore.getState().setAuth({
                    user: {
                        ...
                        ...(data.user?.businessNumber && { businessNumber: data.user.businessNumber }),
                        ...(data.user?.representative && { representative: data.user.representative }),
                        ...(data.user?.address && { address: data.user.address }),
                        ...(data.user?.addressDetail && { addressDetail: data.user.addressDetail }),
                        ...(data.user?.contactPerson && { contactPerson: data.user.contactPerson }),
                    },
