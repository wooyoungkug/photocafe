  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button onClick={() => openDeptDialog()} className="text-[11px]">
      ...
      <div className="flex gap-4">
        ...
        <Card className="w-72 shrink-0">
          <CardHeader className="pb-3">
            <CardTitle className="text-[11px] text-black font-normal flex items-center gap-2">
          ...
          <CardContent className="p-0">
            {deptsLoading ? (
              ...
              <div className="text-center py-8 text-[11px] text-black font-normal opacity-60">
                등록된 부서가 없습니다
              </div>
            ) : (
                        ...
                        <div className="flex items-center gap-2 min-w-0 flex-1">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-1.5">
                              <span className="text-[11px] text-black font-normal truncate">
                                {dept.name}
                              </span>
                              {!dept.isActive && (
                        ...
                        <div className="bg-gray-50/50">
                          {dept.teams
                            ...
                            .map((team, idx) => (
                              <div
                                key={team.id}
                                className={`flex items-center gap-2 pl-8 pr-3 py-1.5 text-[11px] text-black font-normal ${
            ...
            <Card>
              <CardContent className="flex items-center justify-center py-20">
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-black font-normal opacity-60">
                    좌측에서 부서를 선택해주세요
                  </p>
                </div>
              </CardContent>
                ...
                <CardContent>
                  {teamsLoading ? (
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="text-[11px] text-black font-normal w-20">
                            코드
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal">
                            팀명
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal">
                            팀 리더
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal text-center w-20">
                            인원
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal text-center w-20">
                            상태
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal text-center w-16">
                            정렬
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal text-right w-32">
                            작업
                          </TableHead>
                        </TableRow>
                      </TableHeader>
                        ...
                        {teamsForDept
                          ...
                          .map((team) => (
                            <TableRow key={team.id}>
                              <TableCell className="text-[11px] text-black font-normal font-mono">
                                {team.code}
                              </TableCell>
                              ...
                              <TableCell className="text-center text-[11px] text-black font-normal">
                                {team.sortOrder}
                              </TableCell>
                ...
                <Card>
                  ...
                  <CardContent>
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="text-[11px] text-black font-normal w-24">
                            직원ID
                          </TableHead>
                          <TableHead className="text-[11px] text-black font-normal">
                            이름
      ...
      <Dialog open={deptDialogOpen} onOpenChange={setDeptDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-[11px] text-black font-normal">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <Input
                className="text-[11px] text-black font-normal h-8"
            ...
            <div className="space-y-1.5">
              <Label className="text-[11px] text-black font-normal">설명</Label>
              <Textarea
                className="text-[11px] text-black font-normal min-h-[60px] resize-none"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <Label className="text-[11px] text-black font-normal">정렬 순서</Label>
                <Input
                  type="number"
                  className="text-[11px] text-black font-normal h-8"
              ...
              <div className="space-y-1.5">
                <Label className="text-[11px] text-black font-normal">활성 상태</Label>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              >
                <SelectTrigger className="text-[11px] text-black font-normal h-8">
            ...
            <div className="space-y-1.5">
              <Label className="text-[11px] text-black font-normal">팀 리더</Label>
              <Select
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="_none" className="text-[11px] text-black font-normal">
                    미지정
                  </SelectItem>
      ...
      <Dialog open={membersDialogOpen} onOpenChange={setMembersDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="text-[11px] text-black font-normal flex items-center gap-2">
              <Users className="h-4 w-4" />
              팀 멤버 관리
              {selectedTeamDetail && (
          ...
          <div className="space-y-4 py-2">
            {/* 현재 멤버 */}
            <div>
              <h4 className="text-[11px] text-black font-normal mb-2 flex items-center gap-1">
                현재 멤버
              ...
              {!selectedTeamDetail?.staff || selectedTeamDetail.staff.length === 0 ? (
                ...
                <div className="border rounded-md max-h-48 overflow-y-auto">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="text-[11px] text-black font-normal">이름</TableHead>
                        <TableHead className="text-[11px] text-black font-normal">직책</TableHead>
                        <TableHead className="text-[11px] text-black font-normal text-center w-16">
                          리더
                        </TableHead>
                        <TableHead className="text-[11px] text-black font-normal text-right w-20">
                          작업
                        </TableHead>
                      </TableRow>
                    </TableHeader>
              ...
              {availableForAssign.length === 0 ? (
                ...
                <div className="border rounded-md max-h-48 overflow-y-auto">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="text-[11px] text-black font-normal">직원ID</TableHead>
                        <TableHead className="text-[11px] text-black font-normal">이름</TableHead>
                        <TableHead className="text-[11px] text-black font-normal">직책</TableHead>
                        <TableHead className="text-[11px] text-black font-normal text-right w-16">
                          추가
                        </TableHead>
                      </TableRow>
                    </TableHeader>
      ...
      <Dialog open={!!deleteDeptConfirm} onOpenChange={() => setDeleteDeptConfirm(null)}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-[11px] text-black font-normal">부서 삭제</DialogTitle>
            <DialogDescription className="text-[11px]">
              이 작업은 되돌릴 수 없습니다.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={!!deleteTeamConfirm} onOpenChange={() => setDeleteTeamConfirm(null)}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-[11px] text-black font-normal">팀 삭제</DialogTitle>
            <DialogDescription className="text-[11px]">
              이 작업은 되돌릴 수 없습니다.
            </DialogDescription>
          </DialogHeader>
