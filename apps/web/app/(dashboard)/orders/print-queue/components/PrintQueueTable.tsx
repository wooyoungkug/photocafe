      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">주문번호</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">스튜디오<br/>영업담당자</TableHead>
            <TableHead className="text-[14px] text-gray-500 font-normal">상품/폴더</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">규격<br/>Nup</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">편집스타일<br/>제본순서</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">Page<br/>부수</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">용지</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">제본</TableHead>
            <TableHead className="text-center text-[14px] text-gray-500 font-normal">진행상황</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                <TableCell className="text-[14px] text-black font-normal">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    {hasUrgentKeyword(item.folderName || item.productName || '') && (
                      <span className="inline-flex items-center justify-center shrink-0 w-[22px] h-[22px] border-2 border-red-600 text-red-600 text-[9px] font-black -rotate-12 opacity-85 select-none tracking-wider">긴급</span>
                    )}
                ...
                <TableCell className="text-center text-[14px] text-black font-normal">
                  ...
                  <div className={(item.quantity ?? 1) > 1 ? 'text-[14px] font-bold text-red-600' : 'text-[12px] text-black'}>{item.quantity ?? 1}부</div>
                </TableCell>
                <TableCell className="text-center text-[14px] text-black font-normal whitespace-nowrap">
                ...
                <TableCell className="text-center">
                  {(() => {
                    ...
                    const indigoMap: Record<string, { label: string; className: string }> = {
                      pending: { label: '대기', className: 'text-black' },
