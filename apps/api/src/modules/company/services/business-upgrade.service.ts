  ...
  async requestUpgrade(clientId: string, dto: BusinessUpgradeRequestDto) {
    ...
    await this.prisma.client.update({
      ...
      data: {
        ...
        ...(dto.practicalManagerName !== undefined ? { practicalManagerName: dto.practicalManagerName } : {}),
        ...(dto.practicalManagerPhone !== undefined ? { practicalManagerPhone: dto.practicalManagerPhone } : {}),
        ...(dto.approvalManagerName !== undefined ? { approvalManagerName: dto.approvalManagerName } : {}),
        ...(dto.approvalManagerPhone !== undefined ? { approvalManagerPhone: dto.approvalManagerPhone } : {}),
